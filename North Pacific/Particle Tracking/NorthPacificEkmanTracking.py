...
#             'avgU':"/scratch/Victor/AvgTotCur/AverageE*.nc",
#             'avgV':"/scratch/Victor/AvgTotCur/AverageE*.nc",
...
def antiBeach(particle, fieldset, time, dt):
    ...
    particle.lon-=bu*dt*0.0001
    particle.lat-=bv*dt*0.0001
...
#%%
pfile = pset.ParticleFile(name="/scratch/Victor/NorthPacificEkman",
