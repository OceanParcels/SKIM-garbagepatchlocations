...
filenames = {'U': "/scratch/Victor/TotalData24h/20*.nc",
             ...
             'avgU':"/scratch/Victor/AvgTotCur/AverageT*.nc",
             'avgV':"/scratch/Victor/AvgTotCur/AverageT*.nc",
...
totalKernal=move+AdvectionRK4+Beach+EKEsam+Agesam
#%%
pfile = pset.ParticleFile(name="/scratch/Victor/NorthPacificTotal24h",
