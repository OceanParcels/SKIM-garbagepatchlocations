...
filenames = {'U': "/scratch/Victor/TotalData24h/20*.nc",
	     ...
	     'uuss':"/scratch/Victor/StokeData24h/Stoke*.nc",
	     'vuss':"/scratch/Victor/StokeData24h/Stoke*.nc",
...
totalKernal=Advection+move+Agesam+Distsam
#%%
pfile = pset.ParticleFile(name="/scratch/Victor/NorthAtlanticStoke",
