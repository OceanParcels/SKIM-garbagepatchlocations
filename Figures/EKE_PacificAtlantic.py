...
ax1.semilogy(time_axis[1:],AmeanEKExl,'forestgreen',label='End Within Extended Accumulation Zone')
...
ax1.set_ylabel('EKE (m$^2$ s$^{-2}$)',fontsize=axeslabelsize)
...
ax2.semilogy(time_axis[1:],PmeanEKE,'r',label='End Within Accumulation Zone')
ax2.semilogy(time_axis[1:],PmeanEKExl,'forestgreen',label='End Within Extended Accumulation Zone')
...
ax2.set_ylabel('EKE (m$^2$ s$^{-2}$)',fontsize=axeslabelsize)
