...
filenames = {'U': "/scratch/Victor/EkmanData/20*.nc",
             'V': "/scratch/Victor/EkmanData/20*.nc",
#             'avgU':"/scratch/Victor/AvgTotCur/AverageEkmanCurrents.nc",
#             'avgV':"/scratch/Victor/AvgTotCur/AverageEkmanCurrents.nc",
	     'borU':"/scratch/Victor/AvgTotCur/boundary_velocitiesT*",
	     'borV':"/scratch/Victor/AvgTotCur/boundary_velocitiesT*"}
variables = {'U': 'eastward_ekman_current_velocity',
             'V': 'northward_ekman_current_velocity',
#             'avgU':'Uavg',
#             'avgV':'Vavg',
	     'borU':'MaskUvel',
	     'borV':'MaskVvel'}
...
#%%
pfile = pset.ParticleFile(name="/scratch/Victor/GlobalEkman",
