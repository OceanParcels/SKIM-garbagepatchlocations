...
standard='000000-GLOBCURRENT-L4-CURgeo_0m-ALT_OI-v03.0-fv01.0.nc'
...
for i in range(2002,2015):
        ...
        for j in range(1,days+1):
            ...
            U=dataset.variables['eastward_geostrophic_current_velocity'][0,:,:]
            V=dataset.variables['northward_geostrophic_current_velocity'][0,:,:]
            U[U==np.nan]=0
            V[V==np.nan]=0
            meanU+=U
            meanV+=V
...
filename='/scratch/Victor/AverageGeostrophicCurrents.nc'
